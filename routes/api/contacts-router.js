...
import { isEmptyBody, isValidId, authenticate, upload } from '../../middlewars/index.js';
...
contactsRouter.post('/', upload.single("avatar"), validateBody(contactsSchema.contactsAddSchema), contactsController.add);
